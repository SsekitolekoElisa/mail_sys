        ...
        <table class="  table table-bordered">
            <thead>
                <tr class="table-bordered">
                    <td rowspan="2"  bgcolor="#1367EA" class="text-white">P.O Box</td>
                    <td colspan="4" bgcolor="#1367EA"class="text-white">Recipient</td>
                    <td rowspan="2" bgcolor="#1367EA" class="text-white">Added Time</td>
                    <td rowspan="2" bgcolor="#1367EA" class="text-white">Confirmation</td>
                </tr>
                <!-- <tr>
                <hr>
            </tr> -->
            bgcolor="#1367EA"  
                ...
                <tr>
                    <td bgcolor="#1367EA" class="text-white">Client Id</td>
                    <td bgcolor="#1367EA" class="text-white">lname</td>
                    <td  bgcolor="#1367EA" class="text-white">first name</td>
                    <td  bgcolor="#1367EA" class="text-white">Phone number</td>
                </tr>
            </thead>
            <tbody>
