...
$retrieve_query = "SELECT client.boxnumber,client.clientNo,client.fname,client.lname,client.telnumber, mail.addedTime FROM client inner join mail on client.clientNo=mail.clientNo where deliTimedate is not null;";
        ...
        <table class="  table table-bordered">
            <thead>
                <tr class="table-bordered">
                    <td rowspan="2"  bgcolor="#1367EA">P.O Box</td>
                    <td  bgcolor="#1367EA" >Client Id</td>
                    <td  bgcolor="#1367EA" >lname</td>
                    <td  bgcolor="#1367EA" >first name</td>
                    <td  bgcolor="#1367EA" >Phone number</td>
                    <td rowspan="2"  bgcolor="#1367EA">Added Time</td>
                    <td rowspan="2"  bgcolor="#1367EA">Confirmation</td>
            ...
            <tbody>
                ...
                while ($fetch = mysqli_fetch_assoc($execute_query)) { ?>
                    <tr bgcolor="#d9dbdb">
                        ...
                        <td><?php echo $fetch['deliTimedte']; ?></td>
                    
                        <td><button type="submit" class="text-uppercase text-white text-sm w100 fw-normal btn btn-danger btn3-sm" name="submit">Undo</button> </td>
                    </tr>
                <?php } ?>
