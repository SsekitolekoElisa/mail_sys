...
<body background="#000000">
    ...
    <div class="  align-content-center container-fluid  " id="mycontent" style="float: right; margin: 30px; padding: 70px; width: 1250px; ;">
        ...
        <div class="  container bg-light text-uppercase">
            <table align="center">
                <thead>
                    &nbsp;
                    &nbsp;
                ...
                <tbody>
                    <tr>
                        <td> <a href="NewMailAdd.php"> <img src="../images/add.png" alt="" width="200px" height="200px"></a></td>
                        <td> <a href="NewMailAdd.php"><img src="../images/add.png" alt="" width="200px" height="200px"></a></td>
                        <td><a href="NewMailAdd.php"><img src="../images/add.png" alt="" width="200px" height="200px"></a></td>
                    </tr>
                    <tr>
                        <td class="text-dark fw-bold">Kampala Branch</td>
                        <td class="text-dark fw-bold">Entebbe Branch</td>
                        <td class="text-dark fw-bold">Jinja Branch</td>
                    </tr>
            ...
            <table align="center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td class="text-dark fw-bold">Gulu Branch</td>
                        <td class="text-dark fw-bold">Mbarara Branch</td>
                    </tr>
...
|        2 | BR02        | Gulu Branch    | Gule       |
|        3 | BR03        | Jinja Branch   | Jinja      |
|        4 | BR04        | Kampala Branch | Kampala    |
|        5 | BR05        | Mbarara Branch
-->