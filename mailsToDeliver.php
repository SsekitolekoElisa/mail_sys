            ...
            <table width="75%" align="center" class="table table-striped table-hover">
                <tbody>
                    ...
                    <tr bgcolor="#1367EA" class="tr">
                        ...
                        <td  bgcolor="#1367EA" class="text-white">mail_id </td>
                        <td  bgcolor="#1367EA" class="text-white">Added Time</td>
                        <td  bgcolor="#1367EA" class="text-white">Pick up</td>
                        <td  bgcolor="#1367EA" class="text-white">Client</td>
                        <td  bgcolor="#1367EA" class="text-white">P.O BOX</td>
